# This module is based on the https://github.com/phoffer/will_paginate-bulma
# gem. I am adding custom functionality here to take a `maximum_links`
# configuration option that will determine how many links are shown on
# either side of the link for the current page.
#
